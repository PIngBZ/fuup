...
type SmuxServerWrapper struct {
	Session *smux.Session
}

func (h *SmuxServerWrapper) Accept() (net.Conn, error) {
	return h.Session.AcceptStream()
}

func (h *SmuxServerWrapper) Close() error {
	return h.Session.Close()
}

func (h *SmuxServerWrapper) Addr() net.Addr {
	return h.Session.RemoteAddr()
}
